...
<main>
    <div class="media-pc">
        ...
        <div class="effect-switch fixed z-4 bottom-12 right-15">
            <div class="form-check">
                <input type="checkbox" name="effect" class="effect-switch-input form-switch" id="anime" />
                <label class="form-check-label text-white" for="anime">No Distort</label>
            </div>
        </div>
        ...
        <div class="detail absolute z-4 top-0 left-0 cover pointer-events-none hollow">
            <div class="absolute top-34 left-15 pointer-events-auto">
                <div class="flex flex-col space-y-6 max-w-90 text-white text-lg">
                    ...
                    <div>
                        <a class="detail-link" href="https://github.com/alphardex" target="_blank">
                            <text-flash>
                                <div class="slide-in-line">
                                    <div class="slide-in-line-child">
                                        查看详情
        ...
        <div class="about-page absolute z-5 top-0 left-0 cover hollow">
            ...
            <div class="absolute hv-center">
                <div class="space-y-6 text-white" style="max-width: 42rem;">
                    <div class="text-xl leading-loose whitespace-no-wrap">
                        ...
                        <div class="slide-in-line">
                            <div class="slide-in-line-child">Shader。平时喜欢用 Shader 来进行各种创意编程相关的开发，这个网站就</div>
                        </div>
                        <div class="slide-in-line">
                        ...
                        <div class="slide-in-line">
                            <div class="slide-in-line-child">（PS：如果不适应该网站的特效，可以点击右下角的开关关闭它）</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <ul class="text-white space-y-1">
                    <li>
                        <a href="https://github.com/alphardex/" target="_blank">
                            <text-blink text="Github"></text-blink>
                        </a>
                    </li>
                    <li>
                        <a href="https://juejin.cn/user/4353721774401623" target="_blank">
                            <text-blink text="Juejin"></text-blink>
                        </a>
                    </li>
                    <li>
                        <a href="https://codepen.io/alphardex" target="_blank">
                            <text-blink text="CodePen"></text-blink>
                        </a>
                    </li>
                    <li>
                        <a href="https://twitter.com/alphardex007" target="_blank">
                            <text-blink text="Twitter"></text-blink>
                        </a>
                    </li>
                    <li>
                        <a href="https://bangumi.tv/user/399538" target="_blank">
                            <text-blink text="Bangumi"></text-blink>
                        </a>
                    </li>
                    <li>
                        <a href="mailto:2582347430@qq.com">
                            <text-blink text="Email"></text-blink>
                        </a>
                    </li>
                </ul>
            </div>
            <div class="absolute bottom-12 right-15">
                <div class="text-sm text-white space-y-1">
                    ...
                    <div>
                        <a target="_blank" href="https://icons8.com/icon/64794/source-code">Code</a> icon by <a
    ...
    <div class="media-sp">
        <div class="fixed z-5 top-0 left-0 cover">
            <div class="absolute hv-center">
                <div class="space-y-6 text-center text-white">
                    <div class="tracking-widest">我是王浩彬</div>
                    <div class="font-bold text-2xl">
                        <div>一个专注于</div>
                        <div>创新的前端</div>
                    </div>
                    <div>请前往 PC 端查看该页面</div>
                </div>
            </div>
        </div>
    </div>
